...
Pod::Spec.new do |spec|
  ...
  spec.name         = "QuecSmartHomeKit"
  spec.version      = "1.0.0"
  spec.summary      = "QuecSmartHomeKit is smart home kit"
  ...
  spec.ios.vendored_frameworks = "QuecSmartHomeKit/QuecSmartHomeKit.framework"
  spec.source_files = "QuecSmartHomeKit/QuecSmartHomeKit.framework/Headers/*.h"
  spec.public_header_files = "QuecSmartHomeKit/QuecSmartHomeKit.framework/Headers/*.h"
